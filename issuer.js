...
async function getOffer(path) {
  ...
  // console.log(JSON.stringify(openId4VcIssuance.data, null, 2))
  return openId4VcIssuance.data
}
...
<html lang="en">
 ...
 <body>
  ...
  <script>
   ...
   const i = document.querySelector('#instructions')
   ...
   idS.onchange = async function(e) {
    ...
    let url = offer.offerDeeplinkUri
    let qrUrl = offer.offerDeeplinkQrUri

    a.href = url
    a.innerHTML = \`<img src="\${qrUrl}" alt="QR Code">\`
    o.textContent = ''
    o.appendChild(a)
    i.innerHTML = '<span lang="fi">Lue QR-koodi lompakkosovelluksellasi</span><span lang="en">Scan the QR code using your digital wallet</span>'
   }
